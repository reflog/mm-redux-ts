...
import { ChannelTypes, GeneralTypes, PostTypes } from 'action_types';
      ...
      const nextState = reducers.handlePosts(state, {
        ...
        data: {
          ...
          posts: {
            post1: {
              id: 'post1',
              pending_post_id: 'pending1',
            },
            post2: {
              id: 'post2',
              pending_post_id: 'pending2',
            },
          },
        },
      });
...
describe('mergePostOrder', () => {
  ...
  for (const test of tests) {
    it(test.name, () => {
      ...
      expect(actual).toEqual(test.expected); // Arguments shouldn't be mutated
