...
export function channels(state = {}, action) {
  switch (action.type) {
    case ChannelTypes.RECEIVED_CHANNEL:
      if (state[action.data.id] && action.data.type === General.DM_CHANNEL) {
        action.data.display_name =
          action.data.display_name || state[action.data.id].display_name;
      }
    ...
    case ChannelTypes.RECEIVED_CHANNEL_DELETED: {
      ...
      return { ...state, [id]: { ...state[id], delete_at: deleteAt } };
    }
    ...
    case ChannelTypes.UPDATE_CHANNEL_HEADER: {
      ...
      return { ...state, [channelId]: { ...state[channelId], header } };
    }
    ...
    case ChannelTypes.UPDATE_CHANNEL_PURPOSE: {
      ...
      return { ...state, [channelId]: { ...state[channelId], purpose } };
    }
...
function channelsInTeam(state = {}, action) {
  switch (action.type) {
    case ChannelTypes.RECEIVED_CHANNEL: {
      ...
      return { ...state, [action.data.team_id]: nextSet };
    }
...
function myMembers(state = {}, action) {
  switch (action.type) {
    case ChannelTypes.RECEIVED_MY_CHANNEL_MEMBER: {
      ...
      return { ...state, [channelMember.channel_id]: channelMember };
    }
    ...
    case ChannelTypes.RECEIVED_CHANNEL_PROPS: {
      ...
      return { ...state, [action.data.channel_id]: member };
    }
    ...
    case ChannelTypes.INCREMENT_UNREAD_MSG_COUNT: {
      ...
      return {
        ...state,
        [channelId]: { ...member, msg_count: member.msg_count + amount },
      };
    }
    ...
    case ChannelTypes.RECEIVED_LAST_VIEWED_AT: {
      ...
      member = { ...member, last_viewed_at: data.last_viewed_at };
      return { ...state, [action.data.channel_id]: member };
    }
...
function membersInChannel(state = {}, action) {
  switch (action.type) {
    ...
    case ChannelTypes.RECEIVED_CHANNEL_MEMBER: {
      ...
      return { ...state, [member.channel_id]: members };
    }
  ...
  switch (action.type) {
    ...
    case ChannelTypes.ADD_CHANNEL_MEMBER_SUCCESS: {
      ...
      if (nextStat) {
        ...
        return { ...nextState, [id]: { ...nextStat, member_count: count } };
      }
    ...
    case ChannelTypes.REMOVE_CHANNEL_MEMBER_SUCCESS: {
      ...
      if (nextStat) {
        ...
        return {
          ...nextState,
          [id]: { ...nextStat, member_count: count || 1 },
        };
      }
