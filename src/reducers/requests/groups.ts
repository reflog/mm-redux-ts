...
function getAllGroupsAssociatedToTeam(
  state: RequestStatusType = initialRequestState(),
  action: GenericAction
): RequestStatusType {
  return handleRequest(
...
function getAllGroupsAssociatedToChannel(
  state: RequestStatusType = initialRequestState(),
  action: GenericAction
): RequestStatusType {
  return handleRequest(
...
function getGroupsAssociatedToTeam(
  state: RequestStatusType = initialRequestState(),
  action: GenericAction
): RequestStatusType {
  return handleRequest(
...
function getGroupsAssociatedToChannel(
  state: RequestStatusType = initialRequestState(),
  action: GenericAction
): RequestStatusType {
  return handleRequest(
...
function getGroupsNotAssociatedToTeam(
  state: RequestStatusType = initialRequestState(),
  action: GenericAction
): RequestStatusType {
  return handleRequest(
...
function getGroupsNotAssociatedToChannel(
  state: RequestStatusType = initialRequestState(),
  action: GenericAction
): RequestStatusType {
  return handleRequest(
...
const _moduleExport: (
  a: GroupsRequestsStatuses,
  b: GenericAction
) => GroupsRequestsStatuses = combineReducers({
  linkGroupSyncable,
  unlinkGroupSyncable,
  getGroupSyncables,
  getGroupMembers,
