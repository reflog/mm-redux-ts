...
describe('PostUtils', () => {
  ...
  describe('canEditPost', () => {
    ...
    it('should work with new permissions version', () => {
      ...
      newVersionState.entities.roles = {
        roles: {
          system_role: {
            permissions: [Permissions.EDIT_OTHERS_POSTS, Permissions.EDIT_POST],
          },
          team_role: {
            permissions: [],
          },
  ...
  describe('isSystemMessage', () => {
    it('should identify if post is system message', () => {
      const testCases: { output: boolean; input: Partial<Post> }[] = [
        {
          input: {
            type: '' as any,
          },
  ...
  describe('isUserActivityPost', () => {
    it('should identify if post is user activity - add/remove/join/leave channel/team', () => {
      const testCases: { output: boolean; input: PostType }[] = [
        {
          input: '' as any,
          output: false,
        },
        ...
        output: false
          ...
          input: PostTypes.CHANNEL_DELETED,
          output: false,
        },
        {
          input: PostTypes.DISPLAYNAME_CHANGE,
          output: false,
        },
        {
          input: PostTypes.CONVERT_CHANNEL,
          output: false,
        },
        {
          input: PostTypes.EPHEMERAL,
          output: false,
        },
        {
          input: PostTypes.EPHEMERAL_ADD_TO_CHANNEL,
          output: false,
        },
        {
          input: PostTypes.HEADER_CHANGE,
          output: false,
        },
        {
          input: PostTypes.PURPOSE_CHANGE,
          output: false,
        },
        {
          input: PostTypes.JOIN_LEAVE,
          output: false,
        }, // deprecated system type
        {
          input: PostTypes.ADD_REMOVE,
          output: false,
        }, // deprecated system type
        {
          input: PostTypes.COMBINED_USER_ACTIVITY,
          output: false,
        },
        {
          input: PostTypes.ADD_TO_CHANNEL,
          output: true,
        },
        {
          input: PostTypes.JOIN_CHANNEL,
          output: true,
        },
        {
          input: PostTypes.LEAVE_CHANNEL,
          output: true,
        },
        {
          input: PostTypes.REMOVE_FROM_CHANNEL,
          output: true,
        },
        {
          input: PostTypes.ADD_TO_TEAM,
          output: true,
        },
        {
          input: PostTypes.JOIN_TEAM,
          output: true,
        },
        {
          input: PostTypes.LEAVE_TEAM,
          output: true,
        },
        {
          input: PostTypes.REMOVE_FROM_TEAM,
          output: true,
        },
      ];
      testCases.forEach(testCase => {
  ...
  describe('isPostCommentMention', () => {
    const currentUser: Partial<UserProfile> = {
      id: 'currentUser',
      notify_props: {
        comments: 'any',
      },
    ...
    it('should return false as root post is not by currentUser and notify_props is root', () => {
      ...
      const modifiedCurrentUser: Partial<UserProfile> = {
        ...currentUser,
        notify_props: {
          comments: 'root',
        },
  ...
  describe('isMeMessage', () => {
    it('should correctly identify messages generated from /me', () => {
      for (const data of new Array<{ result: boolean; post: Partial<Post> }>(
        {
          post: {
            type: 'hello' as any,
          },
        ...
        assert.equal(confirmation, data.result);
      }
    });
  });
});
