...
describe('makeFilterPostsAndAddSeparators', () => {
  it('filter join/leave posts', () => {
    ...
    const indicateNewMessages = true; // Defaults to show post
    ...
    assert.deepEqual(now, ['1002', '1001', 'date-' + today.getTime()]); // Show join/leave posts
    ...
    assert.deepEqual(now, ['1002', '1001', 'date-' + today.getTime()]); // Hide join/leave posts
    ...
    assert.deepEqual(now, ['1001', 'date-' + today.getTime()]); // always show join/leave posts for the current user
  ...
  it('new messages indicator', () => {
    ...
    assert.deepEqual(now, ['1010', '1005', '1000', 'date-' + today.getTime()]);
    now = filterPostsAndAddSeparators(state, {
      postIds,
      indicateNewMessages: true,
    });
    ...
    assert.deepEqual(now, ['1010', '1005', '1000', 'date-' + today.getTime()]); // Show new messages indicator before all posts
  ...
  it('memoization', () => {
    ...
    today.setHours(0, 0, 0, 0);
    tomorrow.setHours(0, 0, 0, 0); // Posts 7 hours apart so they should appear on multiple days
    ...
    const initialPosts = {
      ...
      1005: {
        id: '1005',
        create_at: tomorrow + '' + 5,
        type: '',
        props: {},
      },
      1006: {
        id: '1006',
        create_at: tomorrow + '' + 10,
        type: Posts.POST_TYPES.JOIN_CHANNEL,
        props: {},
      },
    };
  ...
  describe('memoization', () => {
    ...
    test('should not recalculate when an unrelated state change occurs', () => {
      ...
      state = {
        ...
        entities: {
          ...state.entities,
          posts: { ...state.entities.posts, selectedPostId: 'post2' },
        },
      };
      combineUserActivityPosts(state, initialPostIds);
      expect(combineUserActivityPosts.recomputations()).toBe(1);
    ...
    test('should recalculate if any post changes, but should return the same results if possible', () => {
      ...
      expect(combineUserActivityPosts.recomputations()).toBe(1); // An unrelated post changed
      ...
      expect(combineUserActivityPosts.recomputations()).toBe(2);
      expect(result).toBe(initialResult); // One of the posts was updated, but post type didn't change
      ...
      expect(result).toBe(initialResult); // One of the posts changed type
...
describe('isCombinedUserActivityPost', () => {
  test('should correctly identify combined user activity posts', () => {
    ...
    expect(isCombinedUserActivityPost('user-activity-post1_post2_post4')).toBe(
      true
    );
  });
});
describe('getPostIdsForCombinedUserActivityPost', () => {
  test('should get IDs correctly', () => {
    expect(
      getPostIdsForCombinedUserActivityPost('user-activity-post1_post2_post3')
...
describe('getLastPostIndex', () => {
  ...
  test.only('should skip the new message line and return index of last post', () => {
    expect(
      getLastPostIndex(['post2', 'post3', 'post4', START_OF_NEW_MESSAGES])
    ).toBe(2);
  });
});
...
describe('combineUserActivitySystemPost', () => {
  ...
  const postAddToChannel4 = {
    type: PostTypes.ADD_TO_CHANNEL,
    user_id: 'user_id_2',
    props: {
      addedUserId: 'added_user_id_4',
      addedUsername: 'added_username_4',
    },
  };
  const postAddToChannel5 = {
    type: PostTypes.ADD_TO_CHANNEL,
    user_id: 'user_id_1',
    props: {
      addedUsername: 'added_username_1',
  ...
  it('should match return for ADD_TO_CHANNEL', () => {
    ...
    assert.deepEqual(
      combineUserActivitySystemPost([postAddToChannel1] as any),
      out1
    );
    const out2 = {
      ...
      messageData: [
        {
          actorId: 'user_id_1',
          postType: PostTypes.ADD_TO_CHANNEL,
          userIds: ['added_username_1'],
        },
      ],
    };
    assert.deepEqual(
      combineUserActivitySystemPost([postAddToChannel5] as any),
      out5
    );
    const out6 = {
      allUserIds: [
      ...
      combineUserActivitySystemPost([
        {
          ...postAddToChannel1,
          props: {
            addedUsername: 'added_user_name_1',
          },
        },
      ] as any),
      out1
      ...
      messageData: [
        {
          actorId: 'user_id_1',
          postType: PostTypes.ADD_TO_CHANNEL,
          userIds: ['added_user_name_1', 'added_user_id_2'],
        },
      ],
    };
    assert.deepEqual(
  ...
  it('should match return for ADD_TO_TEAM', () => {
    ...
    assert.deepEqual(
      combineUserActivitySystemPost([postAddToTeam1] as any),
      out1
    );
    const out2 = {
      allUserIds: ['added_user_id_1', 'added_user_id_2', 'user_id_1'],
    ...
    assert.deepEqual(
      combineUserActivitySystemPost([postAddToTeam1, postAddToTeam2] as any),
      out2
    );
    const out3 = {
      allUserIds: [
  ...
  const postJoinChannel1 = {
    type: PostTypes.JOIN_CHANNEL,
    user_id: 'user_id_1',
  };
  const postJoinChannel2 = {
    type: PostTypes.JOIN_CHANNEL,
    user_id: 'user_id_2',
  };
  const postJoinChannel3 = {
    type: PostTypes.JOIN_CHANNEL,
    user_id: 'user_id_3',
  };
  ...
  it('should match return for JOIN_CHANNEL', () => {
    ...
    assert.deepEqual(
      combineUserActivitySystemPost([postJoinChannel1] as any),
      out1
    );
    const out2 = {
  ...
  it('should match return for JOIN_TEAM', () => {
    ...
    assert.deepEqual(
      combineUserActivitySystemPost([postJoinTeam1] as any),
      out1
    );
    const out2 = {
      allUserIds: ['user_id_1', 'user_id_2'],
    ...
    assert.deepEqual(
      combineUserActivitySystemPost([postJoinTeam1, postJoinTeam2] as any),
      out2
    );
    const out3 = {
      allUserIds: ['user_id_1', 'user_id_2', 'user_id_3'],
  ...
  const postLeaveChannel1 = {
    type: PostTypes.LEAVE_CHANNEL,
    user_id: 'user_id_1',
  };
  const postLeaveChannel2 = {
    type: PostTypes.LEAVE_CHANNEL,
    user_id: 'user_id_2',
  };
  const postLeaveChannel3 = {
    type: PostTypes.LEAVE_CHANNEL,
    user_id: 'user_id_3',
  };
  const postLeaveChannel4 = {
    type: PostTypes.LEAVE_CHANNEL,
    user_id: 'user_id_4',
  };
  it('should match return for LEAVE_CHANNEL', () => {
    ...
    assert.deepEqual(
      combineUserActivitySystemPost([postLeaveChannel1] as any),
      out1
    );
    const out2 = {
      allUserIds: ['user_id_1', 'user_id_2'],
  ...
  const postLeaveTeam1 = {
    type: PostTypes.LEAVE_TEAM,
    user_id: 'user_id_1',
  };
  const postLeaveTeam2 = {
    type: PostTypes.LEAVE_TEAM,
    user_id: 'user_id_2',
  };
  const postLeaveTeam3 = {
    type: PostTypes.LEAVE_TEAM,
    user_id: 'user_id_3',
  };
  const postLeaveTeam4 = {
    type: PostTypes.LEAVE_TEAM,
    user_id: 'user_id_4',
  };
  it('should match return for LEAVE_TEAM', () => {
    ...
    assert.deepEqual(
      combineUserActivitySystemPost([postLeaveTeam1] as any),
      out1
    );
    const out2 = {
      allUserIds: ['user_id_1', 'user_id_2'],
    ...
    assert.deepEqual(
      combineUserActivitySystemPost([postLeaveTeam1, postLeaveTeam2] as any),
      out2
    );
    const out3 = {
      allUserIds: ['user_id_1', 'user_id_2', 'user_id_3'],
  ...
  const postRemoveFromChannel2 = {
    type: PostTypes.REMOVE_FROM_CHANNEL,
    user_id: 'user_id_1',
    props: {
      removedUserId: 'removed_user_id_2',
    },
  };
  const postRemoveFromChannel3 = {
    type: PostTypes.REMOVE_FROM_CHANNEL,
    user_id: 'user_id_1',
    props: {
      removedUserId: 'removed_user_id_3',
    },
  };
  const postRemoveFromChannel4 = {
    type: PostTypes.REMOVE_FROM_CHANNEL,
    user_id: 'user_id_1',
    props: {
      removedUserId: 'removed_user_id_4',
    },
  };
  it('should match return for REMOVE_FROM_CHANNEL', () => {
    ...
    assert.deepEqual(
      combineUserActivitySystemPost([postRemoveFromChannel1] as any),
      out1
    );
    const out2 = {
  ...
  const postRemoveFromTeam1 = {
    type: PostTypes.REMOVE_FROM_TEAM,
    user_id: 'user_id_1',
  };
  const postRemoveFromTeam2 = {
    type: PostTypes.REMOVE_FROM_TEAM,
    user_id: 'user_id_2',
  };
  const postRemoveFromTeam3 = {
    type: PostTypes.REMOVE_FROM_TEAM,
    user_id: 'user_id_3',
  };
  const postRemoveFromTeam4 = {
    type: PostTypes.REMOVE_FROM_TEAM,
    user_id: 'user_id_4',
  };
  it('should match return for REMOVE_FROM_TEAM', () => {
    ...
    assert.deepEqual(
      combineUserActivitySystemPost([postRemoveFromTeam1] as any),
      out1
    );
    const out2 = {
      allUserIds: ['user_id_1', 'user_id_2'],
  ...
  it('should match return on combination', () => {
    ...
    const out7 = {
      ...
      messageData: [
        {
          postType: PostTypes.JOIN_TEAM,
          userIds: ['user_id_3', 'user_id_4', 'user_id_1', 'user_id_2'],
        },
        {
          actorId: 'user_id_1',
          postType: PostTypes.ADD_TO_TEAM,
  ...
  it('should sort post type correctly', () => {
    for (const testCase of testCases) {
      ...
      testCase.sort(comparePostTypes).forEach((sortedTestCase, index) => {
        if (index > 0) {
          assert.ok(
            postTypePriority[previousType] <=
              postTypePriority[sortedTestCase.postType],
