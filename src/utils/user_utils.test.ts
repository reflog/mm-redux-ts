...
describe('user utils', () => {
  ...
  describe('filterProfilesMatchingTerm', () => {
    ...
    it('should match by split part of the username', () => {
      assert.deepEqual(filterProfilesMatchingTerm(users, 'split'), [
        userA,
        userB,
      ]);
    ...
    it('should match by firstname', () => {
      assert.deepEqual(filterProfilesMatchingTerm(users, 'First'), [
        userA,
        userB,
      ]);
    });
    it('should match by lastname prefix', () => {
      assert.deepEqual(filterProfilesMatchingTerm(users, 'Last'), [
        userA,
        userB,
      ]);
    });
    ...
    it('should match by fullname prefix', () => {
      assert.deepEqual(filterProfilesMatchingTerm(users, 'First Last'), [
        userA,
        userB,
      ]);
    });
    it('should match by fullname fully', () => {
      assert.deepEqual(filterProfilesMatchingTerm(users, 'First Last1'), [
        userA,
      ]);
    });
    ...
    it('should match by full email', () => {
      assert.deepEqual(filterProfilesMatchingTerm(users, 'left@right.com'), [
        userB,
      ]);
    });
