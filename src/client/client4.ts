...
import fetch, { TFetchOptions } from './fetch_etag';
...
export default class Client4 {
  ...
  translations: { connectionError: string; unknownError: string };
  userRoles: any;
  ...
  getProfilesByIds = async userIds => {
    ...
    return this.doFetch(`${this.getUsersRoute()}/ids`, {
      method: 'post',
  ...
  getUserAccessTokensForUser = async (
    userId,
    page = 0,
    perPage = PER_PAGE_DEFAULT
  ) => {
  ...
  updateTeamMemberSchemeRoles = async (
    teamId,
    userId,
    isSchemeUser,
    isSchemeAdmin
  ...
  getChannelByNameAndTeamName = async (
    teamName,
    channelName,
  ...
  autocompleteChannelsForSearch = async (teamId, name) => {
    return this.doFetch(
      `${this.getTeamRoute(
        teamId
      )}/channels/search_autocomplete${buildQueryString({
        name,
      })}`,
      {
        method: 'get',
  ...
  updateChannelMemberSchemeRoles = async (
    channelId,
    userId,
    isSchemeUser,
    isSchemeAdmin
  ...
  getPostThread = async postId => {
    return this.doFetch(`${this.getPostRoute(postId)}/thread`, {
      method: 'get',
    });
  };
  ...
  getAutocompleteCommandsList = async (
    teamId,
    page = 0,
    perPage = PER_PAGE_DEFAULT
  ) => {
  ...
  getGroupMembers = async (groupID, page = 0, perPage = PER_PAGE_DEFAULT) => {
    return this.doFetch(
      `${this.getBaseRoute()}/groups/${groupID}/members${buildQueryString({
        page,
        per_page: perPage,
      })}`,
      {
  ...
  getGroupsNotAssociatedToTeam = async (
    teamID,
    q = '',
    page = 0,
    perPage = PER_PAGE_DEFAULT
    ...
    return this.doFetch(
      `${this.getBaseRoute()}/groups${buildQueryString({
  ...
  getGroupsNotAssociatedToChannel = async (
    channelID,
    q = '',
    page = 0,
    perPage = PER_PAGE_DEFAULT
  ...
  getGroupsAssociatedToTeam = async (
    teamID,
    q = '',
    page = 0,
    perPage = PER_PAGE_DEFAULT
  ...
  getGroupsAssociatedToChannel = async (
    channelID,
    q = '',
    page = 0,
    perPage = PER_PAGE_DEFAULT
  ...
  channelMembersMinusGroupMembers = async (
    channelID,
    groupIDs,
    page,
    perPage
