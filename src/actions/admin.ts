...
import { batchActions, ActionFunc } from 'types/actions';
...
export function updateConfig(config: any): ActionFunc {
  return bindClientFunc({
...
export function getEnvironmentConfig(): ActionFunc {
  return bindClientFunc({
    ...
    onSuccess: [
      AdminTypes.RECEIVED_ENVIRONMENT_CONFIG,
...
export function createComplianceReport(job: Partial<Job>): ActionFunc {
  return bindClientFunc({
...
export function getComplianceReports(
  ...
  return bindClientFunc({
    ...
    onRequest: AdminTypes.GET_COMPLIANCE_REQUEST,
    onSuccess: [
      AdminTypes.RECEIVED_COMPLIANCE_REPORTS,
      AdminTypes.GET_COMPLIANCE_SUCCESS,
    ],
    onFailure: AdminTypes.GET_COMPLIANCE_FAILURE,
    params: [page, perPage],
...
export function getClusterStatus(): ActionFunc {
  return bindClientFunc({
    ...
    onSuccess: [
      AdminTypes.RECEIVED_CLUSTER_STATUS,
...
export function getLdapGroups(
  ...
  return bindClientFunc({
    ...
    onSuccess: [
      AdminTypes.RECEIVED_LDAP_GROUPS,
...
export function getSamlCertificateStatus(): ActionFunc {
  return bindClientFunc({
    ...
    onSuccess: [
      AdminTypes.RECEIVED_SAML_CERT_STATUS,
...
export function getPluginStatuses(): ActionFunc {
  return bindClientFunc({
    ...
    onSuccess: [
      ...
      AdminTypes.RECEIVED_PLUGIN_STATUSES,
    ],
