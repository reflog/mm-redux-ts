...
import { ActionFunc, batchActions } from 'types/actions';
...
export function createScheme(scheme: Partial<Scheme>): ActionFunc {
  return bindClientFunc({
...
export function getSchemeTeams(
  ...
  return bindClientFunc({
    ...
    onSuccess: [
      SchemeTypes.RECEIVED_SCHEME_TEAMS,
...
export function getSchemeChannels(
  ...
  return bindClientFunc({
    ...
    onSuccess: [
      SchemeTypes.RECEIVED_SCHEME_CHANNELS,
