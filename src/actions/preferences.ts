...
export function deletePreferences(
  userId: string,
  preferences: Array<PreferenceType>
): ActionFunc {
...
export function getMyPreferences(): ActionFunc {
  return bindClientFunc({
    ...
    onSuccess: [
      PreferenceTypes.RECEIVED_ALL_PREFERENCES,
...
export function makeDirectChannelVisibleIfNecessary(
  ...
  return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
    ...
    let preference =
      myPreferences[
        getPreferenceKey(Preferences.CATEGORY_DIRECT_CHANNEL_SHOW, otherUserId)
      ];
...
export function makeGroupMessageVisibleIfNecessary(
  ...
  return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
    ...
    let preference =
      myPreferences[
        getPreferenceKey(Preferences.CATEGORY_GROUP_CHANNEL_SHOW, channelId)
      ];
...
export function deleteTeamSpecificThemes(): ActionFunc {
  return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
    ...
    const themePreferences: Array<PreferenceType> = getCategory(
      state,
