...
export function createIncomingHook(hook: Partial<IncomingWebhook>) {
...
export function getIncomingHooks(
  ...
  return bindClientFunc({
    ...
    onRequest: IntegrationTypes.GET_INCOMING_HOOKS_REQUEST,
    onSuccess: [
      IntegrationTypes.RECEIVED_INCOMING_HOOKS,
      IntegrationTypes.GET_INCOMING_HOOKS_SUCCESS,
    ],
    onFailure: IntegrationTypes.GET_INCOMING_HOOKS_FAILURE,
...
export function createOutgoingHook(hook: Partial<OutgoingWebhook>) {
  return bindClientFunc({
...
export function getOutgoingHooks(
  ...
  return bindClientFunc({
    ...
    onRequest: IntegrationTypes.GET_OUTGOING_HOOKS_REQUEST,
    onSuccess: [
      IntegrationTypes.RECEIVED_OUTGOING_HOOKS,
      IntegrationTypes.GET_OUTGOING_HOOKS_SUCCESS,
    ],
    onFailure: IntegrationTypes.GET_OUTGOING_HOOKS_FAILURE,
...
export function getCommands(teamId: string) {
  return bindClientFunc({
    ...
    onSuccess: [
      IntegrationTypes.RECEIVED_COMMANDS,
...
export function getCustomTeamCommands(teamId: string) {
  return bindClientFunc({
    ...
    onSuccess: [
      IntegrationTypes.RECEIVED_CUSTOM_TEAM_COMMANDS,
...
export function addCommand(command: Command) {
  return bindClientFunc({
    ...
    onSuccess: [
      IntegrationTypes.RECEIVED_COMMAND,
...
export function addOAuthApp(app: OAuthApp) {
  return bindClientFunc({
    ...
    onSuccess: [
      IntegrationTypes.RECEIVED_OAUTH_APP,
...
export function getOAuthApps(
  ...
  return bindClientFunc({
    ...
    onSuccess: [
      IntegrationTypes.RECEIVED_OAUTH_APPS,
...
export function submitInteractiveDialog(submission: Partial<DialogSubmission>) {
  return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
    dispatch({
