...
describe('Actions.Groups', () => {
  ...
  it('getGroupSyncables', async () => {
    ...
    await Actions.getGroupSyncables(groupID, Groups.SYNCABLE_TYPE_TEAM)(
      store.dispatch,
      store.getState
    );
    await Actions.getGroupSyncables(groupID, Groups.SYNCABLE_TYPE_CHANNEL)(
      store.dispatch,
      store.getState
    );
  ...
  it('getGroupMembers', async () => {
    ...
    nock(Client4.getBaseRoute())
      ...
      .reply(200, response);
    await Actions.getGroupMembers(groupID, 0, 100)(
      store.dispatch,
      store.getState
    );
    const state = store.getState();
    ...
    assert.ok(
      groupMembers[groupID].totalMemberCount === response.total_member_count
    );
    assert.ok(
      JSON.stringify(response.members[0]) ===
        JSON.stringify(groupMembers[groupID].members[0])
    );
  });
  it('getGroup', async () => {
    const groupID = '5rgoajywb3nfbdtyafbod47rya';
  ...
  it('getAllGroupsAssociatedToTeam', async () => {
    ...
    nock(Client4.getBaseRoute())
      ...
      .reply(200, response);
    await Actions.getAllGroupsAssociatedToTeam(teamID)(
      store.dispatch,
      store.getState
    );
    const state = store.getState();
  ...
  it('getGroupsAssociatedToTeam', async () => {
    ...
    nock(Client4.getBaseRoute())
      .get(
        `/teams/${teamID}/groups?page=100&per_page=60&q=0&include_member_count=true`
      )
      .reply(200, response);
    await Actions.getGroupsAssociatedToTeam(teamID, '0', 100)(
      store.dispatch,
      store.getState
    );
    const state = store.getState();
  ...
  it('getGroupsNotAssociatedToTeam', async () => {
    ...
    nock(Client4.getBaseRoute())
      ...
      .reply(200, response);
    await Actions.getGroupsNotAssociatedToTeam(teamID, '0', 100)(
      store.dispatch,
      store.getState
    );
    const state = store.getState();
  ...
  it('getAllGroupsAssociatedToChannel', async () => {
    ...
    nock(Client4.getBaseRoute())
      ...
      .reply(200, response);
    await Actions.getAllGroupsAssociatedToChannel(channelID)(
      store.dispatch,
      store.getState
    );
    const state = store.getState();
  ...
  it('getGroupsAssociatedToChannel', async () => {
    ...
    nock(Client4.getBaseRoute())
      .get(
        `/channels/${channelID}/groups?page=100&per_page=60&q=0&include_member_count=true`
      )
      .reply(200, response);
    await Actions.getGroupsAssociatedToChannel(channelID, '0', 100)(
      store.dispatch,
      store.getState
    );
    const state = store.getState();
    ...
    const count =
      state.entities.channels.groupsAssociatedToChannel[channelID].totalCount;
    assert.equal(count, response.total_group_count);
  });
  it('getGroupsNotAssociatedToChannel', async () => {
    ...
    nock(Client4.getBaseRoute())
      ...
      .reply(200, response);
    await Actions.getGroupsNotAssociatedToChannel(channelID, '0', 100)(
      store.dispatch,
      store.getState
    );
    const state = store.getState();
