...
describe('Actions.Users', () => {
  ...
  it('createUser', async () => {
    ...
    const { data: user } = (await Actions.createUser(userToCreate)(
      store.dispatch,
      store.getState
    )) as { data };
  ...
  it('loginById', async () => {
    ...
    await TestHelper.basicClient4.logout();
    TestHelper.mockLogin();
    await Actions.loginById(user.id, 'password1')(
      store.dispatch,
      store.getState
    );
    const state = store.getState();
  ...
  it('updateMyTermsOfServiceStatus accept terms', async () => {
    ...
    TestHelper.mockLogin();
    await Actions.login(user.email, 'password1')(
      store.dispatch,
      store.getState
    );
    nock(Client4.getBaseRoute())
  ...
  it('logout', async () => {
    ...
    assert.deepStrictEqual(
      users.profilesInTeam,
      {},
      'users profiles in team not empty'
    );
    assert.deepStrictEqual(
      users.profilesInChannel,
      {},
      'users profiles in channel not empty'
    );
    assert.deepStrictEqual(
      users.profilesNotInChannel,
      {},
  ...
  it('getProfilesNotInTeam', async () => {
    ...
    nock(Client4.getUsersRoute())
      ...
      .query(true)
      .reply(200, [user]);
    await Actions.getProfilesNotInTeam(team.id, false)(
      store.dispatch,
      store.getState
    );
  ...
  it('autocompleteUsers', async () => {
    ...
    const autocompleteRequest = store.getState().requests.users
      .autocompleteUsers;
    const {
      profiles,
  ...
  it('updateUserRoles', async () => {
    TestHelper.mockLogin();
    await Actions.login(TestHelper.basicUser.email, 'password1')(
      store.dispatch,
      store.getState
    );
    ...
    nock(Client4.getBaseRoute())
      ...
      .reply(200, OK_RESPONSE);
    await Actions.updateUserRoles(currentUserId, ['system_user system_admin'])(
      store.dispatch,
      store.getState
    );
    const { profiles } = store.getState().entities.users;
  ...
  it('updateUserMfa', async () => {
    ...
    nock(Client4.getBaseRoute())
      ...
      .reply(200, OK_RESPONSE);
    await Actions.updateUserMfa(currentUserId, false, '')(
      store.dispatch,
      store.getState
    );
    const { profiles } = store.getState().entities.users;
  ...
  it('updateUserPassword', async () => {
    ...
    nock(Client4.getUsersRoute())
      ...
      .reply(200, OK_RESPONSE);
    await Actions.updateUserPassword(currentUserId, 'password1', 'password1')(
      store.dispatch,
      store.getState
    );
    const { profiles } = store.getState().entities.users;
  ...
  it('checkMfa', async () => {
    ...
    const { data: mfaRequired } = (await Actions.checkMfa(user.email)(
      store.dispatch,
      store.getState
    )) as { data };
    const state = store.getState();
  ...
  it('revokeUserAccessToken', async () => {
    ...
    userAccessTokensByUser = store.getState().entities.admin
      .userAccessTokensByUser;
