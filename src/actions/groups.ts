...
import { Action, ActionFunc, batchActions } from 'types/actions';
...
export function getAllGroupsAssociatedToTeam(teamID: string): ActionFunc {
  return bindClientFunc({
    ...
    onSuccess: [
      GroupTypes.RECEIVED_ALL_GROUPS_ASSOCIATED_TO_TEAM,
...
export function getAllGroupsAssociatedToChannel(channelID: string): ActionFunc {
  return bindClientFunc({
    ...
    onSuccess: [
      GroupTypes.RECEIVED_ALL_GROUPS_ASSOCIATED_TO_CHANNEL,
...
export function getGroupsAssociatedToTeam(
  ...
  return bindClientFunc({
    ...
    onSuccess: [
      GroupTypes.RECEIVED_GROUPS_ASSOCIATED_TO_TEAM,
...
export function getGroupsAssociatedToChannel(
  ...
  return bindClientFunc({
    ...
    onSuccess: [
      GroupTypes.RECEIVED_GROUPS_ASSOCIATED_TO_CHANNEL,
