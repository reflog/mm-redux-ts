...
describe('Selectors.Preferences', () => {
  ...
  describe('get preference', () => {
    ...
    describe('should fallback to the overridden default', () => {
      it('if name unknown', () => {
        assert.deepEqual(
          Selectors.get(testState, category1, 'unknown name', 'fallback'),
          'fallback'
        );
      });
      it('if category unknown', () => {
        assert.deepEqual(
          Selectors.get(testState, 'unknown category', name1, 'fallback'),
          'fallback'
        );
      });
    });
  ...
  describe('get bool preference', () => {
    it('should return the requested value', () => {
      assert.deepEqual(
        Selectors.getBool(testState, category1, name1),
        value1 === 'true'
      );
    });
    describe('should fallback to the default', () => {
    ...
    describe('should fallback to the overridden default', () => {
      it('if name unknown', () => {
        assert.deepEqual(
          Selectors.getBool(testState, category1, 'unknown name', true),
          true
        );
      });
      it('if category unknown', () => {
        assert.deepEqual(
          Selectors.getBool(testState, 'unknown category', name1, true),
          true
        );
      });
    });
  ...
  it('get direct channel show preferences', () => {
    assert.deepEqual(Selectors.getDirectShowPreferences(testState), [
      dmPref1,
      dmPref2,
    ]);
  });
  it('get group channel show preferences', () => {
    assert.deepEqual(Selectors.getGroupShowPreferences(testState), [
      prefGp1,
      prefGp2,
    ]);
  });
